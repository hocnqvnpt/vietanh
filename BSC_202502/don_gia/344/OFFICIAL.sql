...
;
        ...
        where manv_ptm is null
        ;
--CTV_LK tinh cho NVQL_diem ban --> nvql chi tien cho nv lienket
update SSS_DGIA_202502 a
set MANV_PTM = (select x.MA_NVSC from manpn.bscc_import_ptm_shopctv x where a.ma_tb = x.SDT_MUA and x.trang_thai ='Thành công' and x.thang = 202502 )
...
select * from one_line_202502 where ma_tb  in (84889910338,
84942473280,
84944137515,
84945826158,
84945131827,
...
select * from SSS_DGIA_202502 where ma_tb  in (84889910338,
84942473280,
84944137515,
84945826158,
84945131827,
...
from one_line_202502 ;
select *
from ttkd_bsc.va_ct_bsc_ptm_vnptt where thang_ptm = 202502 and ma_tb ='84889910338';
...
select * from ttkd_bsc.va_ct_bsc_ptm_vnptt where thang_ptm =202502 and ma_tb = 84812068035	;
select *
