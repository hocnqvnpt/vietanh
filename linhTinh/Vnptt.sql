...
select *
from TTKD_BSC.bangluong_kpi where thang =202501;
--list_pbh
select * from ocdm_stage.v_reseller_pbh;

CUST_GRP_CD: loại khách hàng

select /*+parallel(32)*/  CUST_GRP_CD from bris.DWB_REGIS_PACKAGE_PUBLISH_NEW where CUST_GRP_CD is null;
